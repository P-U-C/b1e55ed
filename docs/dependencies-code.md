...
engine/mcp/types.py
engine/oracle/chain.py
engine/producers/benchmarks.py
engine/producers/deerflow_research.py
...
engine/review/chain_verdicts.py
engine/spi/admission.py
engine/spi/lifecycle.py
engine/spi/models.py
engine/spi/outcome.py
engine/spi/price_feeds.py
engine/spi/resolution.py
engine/spi/scoring.py
engine/spi/slash.py
```
