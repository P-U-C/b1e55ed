...
echo "  4. PR ${CURRENT_BRANCH} → main"
echo ""
echo "  ⚠️  IMPORTANT: When merging the release PR to main, SQUASH AND MERGE"
echo "  but clear the commit body before merging — keep only the title:"
echo "  'Release ${TAG}'"
echo "  Leaving in the individual commit messages risks [skip ci] in the squash"
echo "  body, which will prevent the Release workflow from firing."
echo ""
echo "  If CI doesn't fire after merge, trigger manually:"
