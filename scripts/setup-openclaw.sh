...
echo "    2) Proceed to Step 6 to install and start the engine service:"
echo "         https://docs.b1e55ed.permanentupperclass.com/setup"
echo "    3) After the engine is running, verify the queue drain cron:"
echo "         openclaw cron list"
echo "    4) Then test the resolver:"
