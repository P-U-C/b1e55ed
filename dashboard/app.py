...
# The route was /. The API was at /api/v1. The client talked to neither.
# Fielding's REST dissertation, Chapter 5: uniform interface.
# Uniformity requires the correct address.
def _startup() -> None:
