...
_BUNDLE_PACKS_RAW: dict[str, dict[str, Any]] = {
    "crypto-core": {
        "id": "crypto-core",
        "name": "Crypto Core",
        "description": "Top liquid crypto — majors + high-conviction alts with direct Binance/Hyperliquid coverage.",
        "symbols": ["BTC", "ETH", "SOL", "BNB", "AVAX", "LINK", "DOGE", "SUI", "HYPE", "ADA"],
        "tags": ["starter", "crypto", "core"],
        "asset_class": "crypto",
        "venue": "global",
        "mappings": {
            "BTC": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar", "liquidity", "beta"]},
            "ETH": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar", "liquidity", "beta"]},
            "SOL": {"mapping": "direct", "confidence": "high", "factors": ["beta", "vol", "liquidity"]},
            "BNB": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "liquidity"]},
            "AVAX": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "liquidity"]},
            "LINK": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "vol"]},
            "DOGE": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "vol"]},
            "SUI": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "liquidity"]},
            "HYPE": {"mapping": "proxy", "confidence": "medium", "proxy_symbol": "SOL", "factors": ["vol", "beta"]},
            "ADA": {"mapping": "direct", "confidence": "low", "factors": ["beta", "liquidity"]},
        },
    },
    "tradfi-infra": {
        "id": "tradfi-infra",
    ...
    "hl-tradfi-perps": {
        ...
        "description": "Equity perps listed on Hyperliquid — US tech, mag7, and high-vol stocks. Prices via yfinance.",
        "symbols": ["AAPL", "TSLA", "NVDA", "AMZN", "GOOGL", "META", "MSFT", "NFLX", "AMD", "COIN", "MSTR", "PLTR"],
        "tags": ["starter", "hyperliquid", "tradfi", "perps", "equities", "stocks"],
        "asset_class": "tradfi",
        "venue": "hyperliquid",
        "mappings": {
            "AAPL": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar", "beta"]},
            "TSLA": {"mapping": "direct", "confidence": "high", "factors": ["beta", "vol"]},
            "NVDA": {"mapping": "direct", "confidence": "high", "factors": ["beta", "vol", "rates"]},
            "AMZN": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar", "beta"]},
            "GOOGL": {"mapping": "direct", "confidence": "high", "factors": ["rates", "beta"]},
            "META": {"mapping": "direct", "confidence": "high", "factors": ["rates", "beta", "vol"]},
            "MSFT": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar", "beta"]},
            "NFLX": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "vol"]},
            "AMD": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "vol"]},
            "COIN": {
                "mapping": "proxy",
                "confidence": "medium",
                "proxy_symbol": "BTC",
                "factors": ["beta", "vol"],
                "note": "Crypto-correlated equity — proxied to BTC for factor analysis.",
            },
            "MSTR": {
                "mapping": "proxy",
                "confidence": "medium",
                "proxy_symbol": "BTC",
                "factors": ["beta", "vol"],
                "note": "BTC proxy equity.",
            },
            "PLTR": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "vol"]},
        },
    },
    "mixed-market": {
        "id": "mixed-market",
        "name": "Mixed Market",
        "description": "Cross-market: crypto majors + macro ETFs + crypto-adjacent equities. Best for cross-asset correlation signals.",
        "symbols": ["BTC", "ETH", "SOL", "SPY", "QQQ", "GLD", "TLT", "NVDA", "COIN", "MSTR"],
        "tags": ["starter", "mixed", "cross-market", "macro"],
        "asset_class": "mixed",
        "venue": "global",
        "mappings": {
            "BTC": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar", "liquidity"]},
            "ETH": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar", "beta", "liquidity"]},
            "SOL": {"mapping": "direct", "confidence": "high", "factors": ["beta", "vol", "liquidity"]},
            "SPY": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar", "liquidity", "beta"]},
            "QQQ": {"mapping": "direct", "confidence": "high", "factors": ["rates", "beta", "liquidity"]},
            "GLD": {"mapping": "direct", "confidence": "high", "factors": ["dollar", "rates", "vol"]},
            "TLT": {"mapping": "direct", "confidence": "high", "factors": ["rates", "dollar"]},
            "NVDA": {"mapping": "direct", "confidence": "medium", "factors": ["beta", "vol", "rates"]},
            "COIN": {"mapping": "proxy", "confidence": "medium", "proxy_symbol": "BTC", "factors": ["beta", "vol"]},
            "MSTR": {"mapping": "proxy", "confidence": "medium", "proxy_symbol": "BTC", "factors": ["beta", "vol"]},
        },
    },
}
